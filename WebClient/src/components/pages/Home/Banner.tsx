        ...
        <div>
            ...
            <section className='px-1 md:px-10 py-36 text-center' id='section-1'>
                <div className='w-full text-left p-4'>
                    <h1 className='text-4xl md:text-5xl leading-10 font-bold'>Collaborate. Manage. Grow.</h1>
                    <br />
                    <br />
                    <p className='text-[20px] text-gray-700'>A multi-tenant employee and task management SaaS for organizations of all sizes.</p>
                    <br />
