  ...
  return (
    ...
    flex flex-row flex-wrap justify-between items-center max-sm:items-start' ref={headerRef}>
      ...
      max-sm:hidden'>
        ...
        <Link href={"/login-org"} className='nav-options 2xl:text-[20px]'>Login organization</Link>
        <Link href={"/login-employee"} className='nav-options 2xl:text-[20px]'>Login to your account</Link>
      </div>
