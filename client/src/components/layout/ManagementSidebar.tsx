...
const menuItems = [
    { href: "/management", label: "Dashboard", icon: <GridViewSharpIcon className="group-hover:text-white" /> },
    { href: "/management/tasks", label: "Tasks", icon: <AssignmentSharpIcon className="group-hover:text-white" /> },
    { href: "/management/people", label: "People", icon: <PeopleOutlineSharpIcon className="group-hover:text-white" /> },

    { href: "/management/notifications", label: "Notifications", icon: <CircleNotificationsSharpIcon className="group-hover:text-white" /> },
];
